...
export const translations = {
  en: {
    ...
    downloader: {
      ...
      simulatingBtn: 'Simulating Stream...',
      creator: 'Creator:',
      identifier: 'Identifier:',
      simulatedNotice: 'Download Stream Simulated:',
      readyAs: 'Ready as',
      prototypeNote: 'Frontend prototype: actual binary downloads will be handled by the future Go backend.',
    },
  ...
  id: {
    ...
    downloader: {
      ...
      quality: 'Kualitas:',
      downloadBtn: 'Unduh',
      simulatingBtn: 'Simulasi Stream...',
      creator: 'Kreator:',
      identifier: 'ID:',
      simulatedNotice: 'Stream Unduhan Disimulasikan:',
      readyAs: 'Siap sebagai',
      prototypeNote: 'Prototipe frontend: unduhan biner sebenarnya akan ditangani oleh backend Go di masa mendatang.',
    },
